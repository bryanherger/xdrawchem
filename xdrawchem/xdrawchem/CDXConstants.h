/*
	...
	$Revision: 2 $
	$Date: 2004-01-24 12:15:18 -0500 (Sat, 24 Jan 2004) $
...
enum CDXDatumID {
	...
	kCDXProp_DrawingSpaceWidth,				// 0x0812 The width of the document. (CDXCoordinate)
	kCDXProp_DrawingSpaceHeight,			// 0x0813 The height of the document. (CDXCoordinate)
